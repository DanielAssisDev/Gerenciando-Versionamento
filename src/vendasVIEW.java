...
public class vendasVIEW extends javax.swing.JFrame {
    ...
    private void listarProdutos() {
        try {
            ...
            ArrayList<ProdutosDTO> listagem = produtosdao.buscarProdutosVendidos();
            
            String colunas[] = {"Identificador", "Nome", "Valor", "Status"};
            String dados [][] = new String[listagem.size()][colunas.length];

            for (int i = 0; i < listagem.size(); i++) {
                dados[i] = new String[]{
                    String.valueOf(listagem.get(i).getId()),
                    listagem.get(i).getNome(),
                    String.valueOf(listagem.get(i).getValor()),
